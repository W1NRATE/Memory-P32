...
int main() {
    string text = "Game Memory, your task is to collect identical pairs of numbers in closed cells, choose a field and a line\n";
    int choice;

    do {
        cout << text << endl;
        cout << "Press 1 to learn or 2 to read new:";
        cin >> choice;
    } while (choice != 1);
    cout << "\nGood luck!\n" << endl;
